...
with open(Path(__file__).resolve().parent / 'KEY_REFS_MAP_from_test3_scripts.txt','w') as f:
...
with open(Path(__file__).resolve().parent / 'POPUP_SURVEY_from_test3_scripts.txt','w') as f:
